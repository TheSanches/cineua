// відображає список схожих фільмів. Компонент приймає масив фільмів (movies) та необов'язковий заголовок (title). Якщо масив фільмів порожній або не визначений, компонент нічого не рендерит. Якщо ж дані є, він використовує бібліотеку Swiper для створення горизонтального слайдера, де кожен слайд представляє окремий фільм. Кожен фільм відображається з постером, назвою, роком випуску та рейтингом. Клік на фільм веде на його сторінку з детальною інформацією.
